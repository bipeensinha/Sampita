                                ...
                                <div className="contact col-lg-4">
                                    <div className="cont-subs">
                                        ...
                                        <div className="cont-add-rgt">
                                            ...
                                            <p><img src="assets/images/indiaflag.png" height="60px" width="80px" className="img-responsive" alt="AZ-500"/></p>
                                            <h4>Address:</h4>
                                            ...
                                            <h4>Address:</h4>
                                            <p className="contact-text-sub">
                                                TechPledge Consulting Service , 9550 forest lane Dallas TX 75243 suite 462, Dallas Texas, Zip Code 75243, +19294945455
                                            </p>
                                            <br />
                                            <hr></hr>
                                            <div className="cont-add-lft">
                                            ...
                                            <p><img src="assets/images/englandflag.png" height="60px" width="80px" className="img-responsive" alt="AZ 900"/></p>
                                            <h4>Address:</h4>
                                            <p className="contact-text-sub">
                                                TechPledge Consulting Service , Crown Street Reading RG1 2SW, Berkshire, UK , +44-776-0976-699
                                            </p>
                        ...
                        <div className="features py-4">
                            ...
                            <div className="float-lt feature-gd col-lg-4 col-sm-6">	
                                    <div className="icon-info">
                                        <h5><img src="assets/images/englandflag.png" height="60px" width="80px" className="img-responsive" alt="Best AWS Certfication"/></h5>
                                        <h6>
                                ...
                                <div className="float-mid feature-gd col-lg-4 col-sm-6 mt-sm-0 mt-4">	
                                    ...
                                    <div className="icon-info">
                                        <h5 ><img src="assets/images/canadaflag.png" height="60px" width="80px" className="img-responsive" alt="Live Project in Azure"/></h5>
                                        <h6>
                                ...
                                <div className="float-rt feature-gd col-lg-4 col-sm-6 mt-lg-0 mt-4">	
                                    ...
                                    <div className="icon-info">
                                        <h5><img src="assets/images/american-flag.png" height="60px" width="80px" className="img-responsive" alt="Live Project in DevOps"/></h5>
                                        <h6>
                                        info@techpledgeconsulting.us <br />
                                        WhatsApp: +1 (936) 436-3003<br />
                                        Call: +1 929 - 494 - 5455
                                        </h6>
                                    </div>
                            </div>	 
