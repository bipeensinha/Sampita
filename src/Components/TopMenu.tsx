                    ...
                    <div className="container">
                            <header className="row top-menu-top">
                                <div className="accounts col-md-9 col-6">
                                        <li className="top_li"><span className="fa fa-phone"></span><a href="tel:(214) 244-4423">(214) 244-4423</a> </li>
                                        <li className="top_li1"><span className="fa fa-envelope-o"></span> <a href="mailto:education-mail@support.com" className="mail"> info@lydiapainting.com</a>	</li>
                                </div>
