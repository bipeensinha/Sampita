                        ...
                        <div className="d-grid grid-col-4 footer-top-29">
                            <div className="footer-list-29 footer-1">
                                ...
                                <ul>
                                    ...
                                    <li><a href="tel:+7-800-999-800"><span className="fa fa-phone"></span> (214) 244-4423</a></li>
                                    <li><a href="mailto:info@lydiapainting.com" className="mail"><span className="fa fa-envelope-open-o"></span>  info@lydiapainting.com</a></li>
                                </ul>
                                <div className="main-social-footer-29">
                                    ...
                                    <a href="https://www.instagram.com/techpledgebangalore/" className="Instagram"><span className="fa fa-instagram"></span></a>
                                </div>
                            </div>
                            <div className="footer-list-29 footer-2">
                                <ul>
                                    ...
                                    <li><a href="https://zoom.us/j/95219122134?pwd=aWxGcVpSbi9tNEF2TzBBek90eEJzQT09" > Live Classes</a></li>
                        ...
                        <p>We'll never share your email address</p>
                            ...
                            <div className="footer-list-29 footer-4">
                                <ul>
                                    ...
                                    <li><a href="https://techpledgetechtalk.freeforums.net/" > Forum</a></li>
                                    <li><a href="https://zoom.us/j/95219122134?pwd=aWxGcVpSbi9tNEF2TzBBek90eEJzQT09" > Demo</a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="d-grid grid-col-2 bottom-copies">
                            <p className="copy-footer-29">©2016-2021. All rights reserved Techpledge Consulting Services</p>
