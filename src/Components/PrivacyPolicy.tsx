			   ...
			   <div className="float-lt feature-gd col-lg-10 col-sm-6">	
					 <div className="icon-info"> <br /><br />
                        ...
                        <h1>Privacy Policy</h1> <br />
                            ...
                            TechPledge keeps appropriate security measures to protect against unauthorized access, alteration, disclosure, or destruction of your personal data that we collect and store in system or applications but no system can be 100% secured, so TechPledge cannot guarantee that your communication and data is secured . Your password is an important part of our security system, and it is your responsibility to protect it. You should not share your password with any third party, and if you believe your password or account has been compromised, you should change it immediately and contact info@lydiapainting.com
                        ...
                        <h3> External Links</h3><br />
                            ...
                            If you do not want us to feature your pictures/testimonials on our website or on our social media channels, you can send an email to info@lydiapainting.com

                            <h3>Personal Information Corrections</h3><br />
                            You can contact us if you notice that the information we are holding is incorrect or incomplete. Please send us an email at info@lydiapainting.com
                            ...
                            If you would like to delete your account, write to info@lydiapainting.com , It may take 7 to 24 Working Days and you will be informed via email , call.
